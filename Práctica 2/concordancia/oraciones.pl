...
oracion12([el,senor,que,vimos,en,la,universidad,era,mi,profesor]).%error
oracion13([juan,que,es,muy,delicado,come,solamente,manzanas,rojas]).%error
oracion14([juan,es,moreno,y,maria,es,alta]).
oracion15([juan,recoge,la,mesa,mientras,maria,toma,un,cafe]).
oracion16([compre,un,pantalon,y,una,corbata,negros]).%Error
oracion17([juan,y,hector,comen,patatas,fritas,y,beben,cerveza]).%error
oracion18([bebimos,y,bailamos,toda,la,noche,mientras,tu,estudiabas]). %error
oracion19([esos,ninos,cantan,y,saltan,y,sonrien,alegres]).te
oracion20([creo,que,necesitais,la,ayuda,de,un,profesional]).%error
oracion21([el,procesador,de,textos,que,es,una,herramienta,muy,potente,sirve,para,escribir,documentos]).%error
