...
oracion_coordinada(oc(Oracion1, Nexo, Oracion2, Nexo, Oracion3)) --> oracion_aux(Oracion1), nexo(Nexo), oracion_aux(Oracion2), nexo(Nexo), oracion_aux(Oracion3).
...
nexo(nexo(AdvN)) --> adverbio_nexo(AdvN).
